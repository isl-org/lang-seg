...
class Classifier(object):
    ...
    def init_prototypes(self, features_s: torch.tensor, features_q: torch.tensor,
        ...
        # use the ground truth mask of the support images to retrieve the corresponding feature vector and sum
        fg_prototype = (features_s * fg_mask).sum(dim=(1, 3, 4))
        
        # shots*h*w = total number of spatial feature vectors are added and get the average (only the locations with label 1 are accounted)
